...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val RESTAURAN_ID = "uewq1zg2zlskfw1e867"
    }
    ...
    private fun postReview(review: String) {
        showLoading(true)
        val client = ApiConfig.getApiService().postReview(RESTAURAN_ID, "Ahmad Fauzan", review)
    ...
    private fun findRestaurant() {
        showLoading(true)
        val client = ApiConfig.getApiService().getRestaurant(RESTAURAN_ID)
